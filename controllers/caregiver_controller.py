...
class CaregiverController:
    ...
    def create_caregiver(self, nombre, apellido, cedula, email, telefono, ciudad, experiencia, rating, precio):
        ...
        success = self.firebase.save_caregiver_data(
            caregiver_id, nombre, apellido, cedula, email, telefono, ciudad, experiencia, rating, precio
        )
        return success
...
class CaregiverController:
    ...
    def update_caregiver(self, caregiver_id, updated_data):
        ...
        return self.firebase.update_caregiver_data(caregiver_id, updated_data)  # Se usa la función correcta

    def delete_caregiver(self, caregiver_id):
        """Elimina un cuidador de Firestore."""
        return self.firebase.delete_caregiver(caregiver_id)  # Se usa la función correcta
